...
const BASE_STYLES = 'inline-flex items-center text-xsm2 font-semibold tracking-1.25 rounded-full px-3.5 h-[1.875rem]';
const BEGINNER_STYLES = 'text-blue-800 bg-blue-rgba';
